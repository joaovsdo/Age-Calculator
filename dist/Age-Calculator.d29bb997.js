...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const picker = (0, _jsDatepickerDefault.default)(datepickerContainer, {
        onSelect: (instance, date)=>{
            if (date) {
                selectedDate = (0, _luxon.DateTime).fromJSDate(date);
    ...
    calculate.addEventListener("click", ()=>{
        if (selectedDate && (0, _luxon.DateTime).now().diff(selectedDate, 'days').days > 0) {
            datepickerContainer.classList.remove('invalid');
            const today = (0, _luxon.DateTime).now();
            const age = today.diff(selectedDate, [
                'years',
                'months',
                'days'
            ]);
...
},{"js-datepicker":"hanq2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","js-datepicker/dist/datepicker.min.css":"77cyx","luxon":"lwUfs"}],"hanq2":[function(require,module,exports,__globalThis) {
!function(e, t) {
    module.exports = t();
}(window, function() {
    return function(e) {
...
},{}],"77cyx":[function() {},{}],"lwUfs":[function(require,module,exports,__globalThis) {
'use strict';
...
},{}]},["7SvX3","kyksZ"], "kyksZ", "parcelRequiredcbb", {})

//# sourceMappingURL=Age-Calculator.d29bb997.js.map
